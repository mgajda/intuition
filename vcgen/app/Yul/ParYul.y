...
%name pListYulIdent ListYulIdent
...
YulStmt
  ...
  | 'let' YulIdent ',' ListYulIdent ':=' YulExpr { AbsYul.YulVarDeclMulti $2 $4 $6 }
  | YulIdent ':=' YulExpr { AbsYul.YulAssign $1 $3 }
  | YulIdent ',' ListYulIdent ':=' YulExpr { AbsYul.YulAssignMulti $1 $3 $5 }
...
ListYulIdent :: { [AbsYul.YulIdent] }
ListYulIdent
  : YulIdent { (:[]) $1 } | YulIdent ',' ListYulIdent { (:) $1 $3 }
